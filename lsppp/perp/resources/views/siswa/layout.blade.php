        ...
        <aside class="hidden md:flex flex-col w-64 bg-white border-r border-gray-100">
            ...
            <div class="flex-1 overflow-y-auto py-6 px-4 space-y-8 custom-scrollbar">
                ...
                <div>
                    ...
                    <nav class="space-y-1">
                        <!-- Dashboard -->
                        <a href="{{ url('/siswa/dashboard') }}" class="group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->is('siswa/dashboard*') ? 'bg-slate-900 text-white shadow-sm shadow-slate-300/50' : 'text-slate-500 hover:bg-gray-50 hover:text-slate-900' }}">
                            <svg class="mr-3 h-5 w-5 shrink-0 {{ request()->is('siswa/dashboard*') ? 'text-white' : 'text-slate-400 group-hover:text-slate-900' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <!-- Borrow Book -->
                        <a href="{{ url('/siswa/order/create') }}" class="group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->is('siswa/order*') ? 'bg-slate-900 text-white shadow-sm shadow-slate-300/50' : 'text-slate-500 hover:bg-gray-50 hover:text-slate-900' }}">
                            <svg class="mr-3 h-5 w-5 shrink-0 {{ request()->is('siswa/order*') ? 'text-white' : 'text-slate-400 group-hover:text-slate-900' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <!-- Return Book -->
                        <a href="{{ url('/siswa/return') }}" class="group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->is('siswa/return*') ? 'bg-slate-900 text-white shadow-sm shadow-slate-300/50' : 'text-slate-500 hover:bg-gray-50 hover:text-slate-900' }}">
                            <svg class="mr-3 h-5 w-5 shrink-0 {{ request()->is('siswa/return*') ? 'text-white' : 'text-slate-400 group-hover:text-slate-900' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <!-- History -->
                        <a href="{{ url('/siswa/history') }}" class="group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->is('siswa/history*') ? 'bg-slate-900 text-white shadow-sm shadow-slate-300/50' : 'text-slate-500 hover:bg-gray-50 hover:text-slate-900' }}">
                            <svg class="mr-3 h-5 w-5 shrink-0 {{ request()->is('siswa/history*') ? 'text-white' : 'text-slate-400 group-hover:text-slate-900' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
