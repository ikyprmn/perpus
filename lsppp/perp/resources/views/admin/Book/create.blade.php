...
@section('content')
    <div class="max-w-2xl mx-auto">
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-slate-800">Add New Book</h1>
            <p class="text-slate-500 text-sm mt-1">Enter the details of the new book to add it to the library.</p>
        </div>

        <!-- Form Card -->
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
            <form action="{{ url('books/create') }}" method="POST" class="p-6 space-y-6">
                @csrf
